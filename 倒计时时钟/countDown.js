...
var RADIUS = WINDOW_WIDTH*0.8*(1/108)-1;
var radius = WINDOW_WIDTH*0.8*(1/108)-1;
var MARGIN_TOP = Math.floor(WINDOW_HEIGHT/5);
var MARGIN_LEFT = Math.floor(WINDOW_WIDTH/10);
	
	
var endTime = new Date();
endTime.setTime(endTime.getTime()+2*3600000);
